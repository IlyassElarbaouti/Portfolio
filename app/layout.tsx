...
export const metadata = {
  ...
  description: "Ilyass is a software engineer developer with 4 years of experience.",
};
...
/>
      ...
      <body className={`${inter.className} bg-gray-50 overflow-x-hidden text-gray-950 relative pt-28 sm:pt-36`}>
